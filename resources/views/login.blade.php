            ...
            <div class="signin-signup">
                <form action="#" class="sign-in-form">
                    ...
                    <div class="input-field">
                        ...
                        <input type="email" name="login_email" id="login_email" class="login_email" placeholder="Email" />
                    </div>
                    <div class="login_email_error"></div>
                    <div class="input-field">
                        <i class="fas fa-lock"></i>
                        <input type="password" name="login_password" id="login_password" class="login_password" placeholder="Password" />
                    </div>
                ...
                <form action="#" class="sign-up-form">
                    ...
                    <div class="input-field">
                        <i class="fas fa-envelope"></i>
                        <input type="email" name="register_email" id="register_email" class="register_email" placeholder="Email" />
                    </div>
                    <div class="register_email_error error"></div>
                    <div class="input-field">
                        <i class="fas fa-lock"></i>
            ...
            $('#login_button').on('click',function(){
                $(".sign-in-form").validate({
                    ...
                    errorPlacement: function(error, element) {
                        if(element.hasClass('login_email')) {
                            error.appendTo('.login_email_error');
                        } else if (element.hasClass('login_password')) {
                            error.appendTo('.login_password_error');
                        } else {
                ...
                $(".sign-up-form").validate({
                    ...
                    errorPlacement: function(error, element) {
                        if (element.hasClass('register_username')) {
                            error.appendTo('.register_username_error');
                        } else if(element.hasClass('register_email')) {
